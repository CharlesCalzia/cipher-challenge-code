...
def bruteforce_vigenere(ciphertext, lengths=list(range(2,12))): #needs work to convert it to copy subsitution bruteforce algo
    for length in lengths:
        ...
        for i in range(3):
            ...
            if pScore>mScore:
                mScore = pScore
                m = p2[:]
                print(f'Length {length} best key: {m} - {decrypt_vigenere(m, ciphertext)[:20]}')